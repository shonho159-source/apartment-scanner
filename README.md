...
סוכן שרץ שלוש פעמים ביום (~09:00, ~15:00, ~20:00 שעון ישראל), סורק קבוצות פייסבוק **ציבוריות** של דירות להשכרה בתל אביב, מסנן עם AI (gpt-5.4-mini) רק פוסטים של **דירות שלמות להשכרה** לפי הקריטריונים שלך, ושולח סיכום מסודר בוואטסאפ.
